...
//static const QString manufacturerName = "Manufacturer";
...
Recomment::Recomment(QObject *parent) :
    QObject(parent),
...
QList<Offer*> Recomment::parseCasebase(const QString& path, const QString& imageBasePath, bool* okay) const
{
...
void Recomment::reset()
{
    m_recommender->init();
}

QString Recomment::critique(const QString& command)
{
...
void Recomment::recommendationChanged(const Offer *o, const QString& explanation)
{
    m_currentRecommendation = o;
    emit recommend(o, explanation);
}

bool Recomment::setupLanguage(const QString& path)
{
...
Relationship* Recomment::buildRelationship(const Offer *offer,
...
AttributeFactory* Recomment::getAttributeFactory() const
{
