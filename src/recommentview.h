...
#ifndef RECOMMENTVIEW_H
#define RECOMMENTVIEW_H
...
class RecommentView : public QObject
{
    Q_OBJECT
...
public:
    explicit RecommentView(bool voiceControlled, QObject *parent = 0);
    virtual ~RecommentView();
